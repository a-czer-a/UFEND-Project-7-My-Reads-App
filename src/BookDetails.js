            ...
            {!isLoaded ? (
                ...
                <div className="book-details">
                    ...
                    <div className="book-info">
                        ...
                        <div className="book-date"><span className="rubric">Publish date:</span> {publishedDate}</div>
                        <div className="book-date"><span className="rubric">Language:</span> {language}</div>
                        <div className="book-date"><span className="rubric">Pages:</span> {pageCount}</div>
                        <div className="book-date"><span className="rubric">Category:</span> {categories}</div>
                        <div className="book-date"><span className="rubric">Average rating:</span> {averageRating}</div>
                    </div>
